...
_FAMILY_DEFINITIONS = (
    ...
    },
    {
        ...
        "primary_workflows": ("source-finder", "research", "paper-learning", "long-document-reading", "data-analysis", "research-department", "feedback-triage"),
    ...
    },
    {
        ...
        "use_for": "New durable memory, existing memory cleanup, rejected-decision recall, project wiki notes, and external connection hints.",
        "primary_workflows": ("memory-new", "memory-sync", "decision-recall", "wiki"),
        ...
        "route_summary": "Separate new-memory capture from existing-memory cleanup, then prepare notes and hints without claiming writes.",
    },
    {
    ...
    },
    {
        ...
        "use_for": "Setup repair, status, automation, workflow learning, and ops cards.",
        "primary_workflows": (
            "doctor",
            "workspace-audit",
            "production-audit",
