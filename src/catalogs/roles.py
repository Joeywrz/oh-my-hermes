...
_ROLES = (
    ...
    RoleDefinition(
        ...
        primary_skills=("research", "web-research", "research-brief"),
    ...
    RoleDefinition(
        ...
        primary_skills=("ultrawork", "ai-slop-cleaner"),
    ...
    RoleDefinition(
        ...
        primary_skills=("ultraperf", "agent-board", "executor-runtime-readiness", "toolbelt-readiness", "ops-observability-card", "doctor", "skill", "cancel"),
