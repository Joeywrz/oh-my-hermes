...
_SPECIALISTS = (
    SpecialistDefinition(
        ...
        eligible_skill_ids=("research", "web-research", "research-brief", "source-finder", "research-department"),
    ...
    SpecialistDefinition(
        ...
        eligible_skill_ids=("deep-interview", "plan", "ralplan", "loop", "curriculum-design", "product-brief", "decision-prototype", "product-discovery-validation"),
    ...
    SpecialistDefinition(
        ...
        eligible_skill_ids=("ultrawork", "ai-slop-cleaner", "build-failure-triage"),
    ...
    SpecialistDefinition(
        ...
        eligible_skill_ids=("code-review", "ultraqa", "ask", "legal-compliance-review", "localization-review"),
        role_projection="reviewer",
