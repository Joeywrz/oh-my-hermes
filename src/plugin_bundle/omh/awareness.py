...
_ROUTE_HINT_RULES = (
    ...
    },
    {
        ...
        "tokens": ("vllm",),
        "adjacent_workflows": ("model-optimization", "model-setup", "performance-goal"),
    },
    {
        "id": "performance_goal",
        "workflow": "performance-goal",
        "lane": "intent_to_plan",
        "next_action": "forward_plan_to_selected_workflow",
        "reason": "The user is invoking the performance-goal workflow surface directly.",
