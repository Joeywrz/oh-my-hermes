...
POPULAR_PLUGIN_FAMILIES: tuple[PopularPluginFamily, ...] = (
    ...
    PopularPluginFamily(
        ...
        "Email, chat, SaaS apps, meeting, gateway, and scheduled connector work",
        9,
        ("email", "slack", "discord", "telegram", "notion", "jira", "linear", "crm", "calendar", "scheduler"),
        (
            "connector-operator",
            "connector-slack-dm",
