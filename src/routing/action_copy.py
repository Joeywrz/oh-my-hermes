...
NEXT_ACTION_LABELS: dict[str, str] = {
    ...
    "forward_plan_to_selected_workflow": "forwarding the plan to the selected workflow",
    ...
    "prepare_decision_prototype": "preparing a bounded decision prototype",
    "prepare_typed_ask": "preparing a typed ask",
    "prepare_route_question_answer": "preparing a route-question answer",
    "prepare_failure_next_move": "preparing a next move for the failing run",
    "prepare_review_flags": "preparing advisory review flags",
    "prepare_action_hold_check": "preparing a fail-closed action check",
    "prepare_completion_objection_check": "preparing a completion objection check",
    "prepare_lifecycle_growth": "preparing a lifecycle growth plan",
    "prepare_product_discovery_validation": "preparing product discovery validation",
    "prepare_sales_pipeline_review": "preparing a sales pipeline review",
    ...
    "prepare_parallel_delivery": "preparing parallel delivery lanes",
    ...
    "show_runtime_handoff": "showing the runtime handoff",
    ...
    "start_goal": "starting the checkpointed goal",
