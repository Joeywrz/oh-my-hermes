...
_HARNESSES = [
    ...
    HarnessDefinition(
        ...
        ("validate loopability_assessment/v1", "validate loop_cycle/v2 and explicit legacy loop_cycle/v1 projection", "inspect loop_engineering/v1 snapshot", "inspect loop_runtime/v1 queue verification_plan", "inspect loop_status_card/v1 failure_mode_summary and native_goal_status", "inspect loop_queue_handoff/v1 when a queued item is actionable", "check linked goal_completion_gate/v1 before completion copy", "inspect loop_goal_driver_handoff/v1 and driver kind before preparing the selected executor goal or native fallback", "record loop_goal_driver_observation/v1 through goal-driver-observe only after host evidence exists", "validate loop_phase_transition/v1 before reporting role progress"),
