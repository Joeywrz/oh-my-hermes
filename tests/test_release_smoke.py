...
class ReleaseSmokeTests(unittest.TestCase):
    ...
    def test_product_readiness_report_rolls_up_public_release_story(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertIn("88/88 dedicated workflow cards", gates["chat_card_coverage"]["summary"])
            ...
            self.assertIn("route hints 10", gates["context_brief_coverage"]["summary"])
            ...
            self.assertIn("context 11/11", gates["hermes_ux_quality"]["summary"])
    ...
    def test_release_evidence_bundle_packages_and_writes_local_evidence(self) -> None:
        with TemporaryDirectory() as tmp:
            ...
            self.assertEqual(payload["summary"]["chat_card_coverage_total"], 88)
            ...
            self.assertEqual(payload["summary"]["route_hint_alignment_total"], 208)
            ...
            self.assertEqual(payload["summary"]["context_brief_route_hint_count"], 10)
