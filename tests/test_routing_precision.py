...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 282)
        self.assertEqual(payload["summary"]["passing_count"], 282)
        self.assertEqual(payload["summary"]["negative_case_count"], 282)
        self.assertEqual(payload["summary"]["negative_passing_count"], 282)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 429)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 429)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 711)
        self.assertEqual(payload["summary"]["total_passing_count"], 711)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("282/282 negative-control cases passing", stdout)
        self.assertIn("Interventions: 429/429 expected workflow cases passing", stdout)
