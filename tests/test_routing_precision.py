...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 241)
        self.assertEqual(payload["summary"]["passing_count"], 241)
        self.assertEqual(payload["summary"]["negative_case_count"], 241)
        self.assertEqual(payload["summary"]["negative_passing_count"], 241)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 634)
        self.assertEqual(payload["summary"]["total_passing_count"], 634)
