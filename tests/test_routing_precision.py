...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["passing_count"], 208)
        self.assertEqual(payload["summary"]["negative_case_count"], 208)
        self.assertEqual(payload["summary"]["negative_passing_count"], 208)
        self.assertEqual(payload["summary"]["direct_answer_count"], 122)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 357)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 357)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 565)
        self.assertEqual(payload["summary"]["total_passing_count"], 565)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("208/208 negative-control cases passing", stdout)
        self.assertIn("Interventions: 357/357 expected workflow cases passing", stdout)
