...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 215)
        self.assertEqual(payload["summary"]["passing_count"], 215)
        self.assertEqual(payload["summary"]["negative_case_count"], 215)
        self.assertEqual(payload["summary"]["negative_passing_count"], 215)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 367)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 367)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 582)
        self.assertEqual(payload["summary"]["total_passing_count"], 582)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("215/215 negative-control cases passing", stdout)
        self.assertIn("Interventions: 367/367 expected workflow cases passing", stdout)
