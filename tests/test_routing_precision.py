...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 248)
        self.assertEqual(payload["summary"]["passing_count"], 248)
        self.assertEqual(payload["summary"]["negative_case_count"], 248)
        self.assertEqual(payload["summary"]["negative_passing_count"], 248)
        self.assertEqual(payload["summary"]["direct_answer_count"], 136)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 407)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 407)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 655)
        self.assertEqual(payload["summary"]["total_passing_count"], 655)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("248/248 negative-control cases passing", stdout)
        self.assertIn("Interventions: 407/407 expected workflow cases passing", stdout)
