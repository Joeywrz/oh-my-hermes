...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 412)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 412)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 668)
        self.assertEqual(payload["summary"]["total_passing_count"], 668)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("Interventions: 412/412 expected workflow cases passing", stdout)
