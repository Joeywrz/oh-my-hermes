...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 222)
        self.assertEqual(payload["summary"]["passing_count"], 222)
        self.assertEqual(payload["summary"]["negative_case_count"], 222)
        self.assertEqual(payload["summary"]["negative_passing_count"], 222)
        self.assertEqual(payload["summary"]["direct_answer_count"], 123)
        ...
        self.assertEqual(payload["summary"]["intervention_case_count"], 375)
        self.assertEqual(payload["summary"]["intervention_passing_count"], 375)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 597)
        self.assertEqual(payload["summary"]["total_passing_count"], 597)
    ...
    def test_routing_precision_cli_outputs_summary_and_json(self) -> None:
        ...
        self.assertIn("222/222 negative-control cases passing", stdout)
        self.assertIn("Interventions: 375/375 expected workflow cases passing", stdout)
