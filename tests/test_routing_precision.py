...
class RoutingPrecisionTests(unittest.TestCase):
    def test_routing_precision_demo_checks_negative_controls(self) -> None:
        ...
        self.assertEqual(payload["summary"]["case_count"], 239)
        self.assertEqual(payload["summary"]["passing_count"], 239)
        self.assertEqual(payload["summary"]["negative_case_count"], 239)
        self.assertEqual(payload["summary"]["negative_passing_count"], 239)
        self.assertEqual(payload["summary"]["direct_answer_count"], 134)
        ...
        self.assertEqual(payload["summary"]["total_case_count"], 630)
        self.assertEqual(payload["summary"]["total_passing_count"], 630)
